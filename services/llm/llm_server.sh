...
# ⚠️ Contested value -- see the note above the exec line. 11 §11A.3.1/.2/.3 writes 2048 and
...
#
# ⚠️ Note what this does and does not do. A second request is QUEUED server-side, not
